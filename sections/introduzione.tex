...
\textbf{Nota}: per ogni sezione, la prima occorrenza dei diversi termini di glossario 
...
Per raggiungere questo obiettivo è stato necessario uno studio di tali
tecnologie e dell'applicazione già esistente, questo ha occupato il primo
periodo di lavoro.
In seguito il nuovo prodotto è stato progettato, sviluppato e testato
fino ad arrivare ad una prima versione rilasciabile. \\

In seguito viene descritta l'applicazione web esistente e vengono
delineati gli obiettivi e gli strumenti previsti per la realizzazione
della controparte mobile.
...
ed un'analisi della sua \gloss{usabilità}, un riassunto si può trovare nella
sezione \ref{usabilita-fiscolo}.
...
in carico un'attività di un progetto senza dover accedere al portale online dall'ufficio
o da un computer portatile.
...
telefonata, senza la necessità di collegarsi al portale web dall'ufficio o da un computer
portatile.
